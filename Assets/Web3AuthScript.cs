...
public class Web3AuthScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*{
            clientId = "BNNGyn7-iElYWKitih_yewE4PCwwJkOXAO1HFGxp7RzJdT4doSVwv66-sxJtFy6vSzZz3QPnjpoDbCwEyVi4L_o",
            redirectUrl = new System.Uri("torusapp://com.metaspace.web3Auth/auth"),
            network = Web3Auth.Network.CYAN,
        });*/
        {
            clientId = web3Auth.clientId,
            redirectUrl = new System.Uri(web3Auth.redirectUri),
